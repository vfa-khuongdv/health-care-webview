      ...
      <div className="animate-fade-in">
        ...
        <div className="bg-linear-to-b from-healthcare-primary/10 to-transparent dark:from-healthcare-primary/20 px-6 pt-10 pb-6 rounded-b-[40px]">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-4 text-xl font-bold text-healthcare-dark dark:text-white">Johnathan Doe</h2>
            <p className="text-xs text-healthcare-muted dark:text-slate-400">{t('profile.blood_type')}: O+ | {t('profile.age')}: 28</p>
            
            <div className="flex space-x-8 mt-6">
              <div className="text-center">
                <p className="text-healthcare-primary font-bold text-lg">178</p>
                <p className="text-[10px] text-healthcare-muted dark:text-slate-500 font-bold uppercase tracking-widest">{t('profile.height')}</p>
              </div>
              <div className="text-center">
                <p className="text-healthcare-primary font-bold text-lg">72kg</p>
                <p className="text-[10px] text-healthcare-muted dark:text-slate-500 font-bold uppercase tracking-widest">{t('profile.weight')}</p>
              </div>
              <div className="text-center">
                <p className="text-healthcare-primary font-bold text-lg">110/80</p>
                <p className="text-[10px] text-healthcare-muted dark:text-slate-500 font-bold uppercase tracking-widest">{t('profile.bp')}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  <h3 className="text-sm font-bold text-healthcare-dark dark:text-white">{item.label}</h3>
                  <p className="text-[10px] text-healthcare-muted dark:text-slate-500">{item.sub}</p>
                </div>
              </div>
