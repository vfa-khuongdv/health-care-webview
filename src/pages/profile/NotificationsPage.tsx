      ...
      <div className="px-6 mt-4 space-y-6 pb-20">
        <div className="space-y-4">
          ...
          <OptionItem
            ...
            rightElement={
              <Toggle value={settings.news} onToggle={() => toggle("news")} />
            }
          />
          <OptionItem
        ...
        <div className="space-y-4 pt-2">
          ...
          <OptionItem
            ...
            rightElement={
              <Toggle value={settings.email} onToggle={() => toggle("email")} />
            }
          />
          <OptionItem
            ...
            rightElement={
              <Toggle value={settings.sms} onToggle={() => toggle("sms")} />
            }
          />
        </div>
      </div>
