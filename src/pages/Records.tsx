    ...
    <div className="px-6 py-4 animate-fade-in pb-10">
      ...
      <div className="space-y-4">
        {records.map((record) => (
          <div
            key={record.id}
            className="bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-premium border border-gray-100 dark:border-slate-800 flex items-center justify-between hover:border-healthcare-primary/30 transition-colors cursor-pointer group"
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="text-sm font-bold text-healthcare-dark dark:text-white group-hover:text-healthcare-primary transition-colors">
                  {record.title}
                </h3>
                <div className="flex items-center space-x-2 mt-1">
                  <span className="text-[10px] text-healthcare-muted dark:text-slate-400 font-medium">
                    {record.date}
                  </span>
            ...
            <div className="text-right">
              <p className="text-[10px] text-healthcare-muted dark:text-slate-500 mb-1">
                {record.size}
              </p>
      ...
      <div className="mt-8 p-4 bg-healthcare-primary/5 dark:bg-healthcare-primary/10 rounded-2xl border border-dashed border-healthcare-primary/30 dark:border-healthcare-primary/40">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-[10px] text-healthcare-muted dark:text-slate-400 max-w-[200px]">
